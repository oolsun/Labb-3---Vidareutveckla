...
namespace VarmDrinkStation
{
    ...
    // Implementerar en specifik fabrik som förbereder varmt kaffe
    ...
    // Implementerar en specifik fabrik som förbereder varm cappuccino
    ...
    // Implementerar en specifik fabrik som förbereder varm choklad
    ...
    public class WarmDrinkMachine
    {
        ...
        public WarmDrinkMachine()
        {
            ...
            RegisterFactory<HotCoffeeFactory>("Coffee"); // Registrerar fabriken för kaffe
            RegisterFactory<HotCappuccinoFactory>("Cappuccino"); // Registrerar fabriken för cappuccino
